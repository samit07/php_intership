...
//display table
$conn=mysqli_connect("localhost","root","","day6");
$qry=mysqli_query($conn,"select * from tbl_studentinfo") or die(mysqli_error($conn));
...
while($row=mysqli_fetch_array($qry)){
    ...
    echo "<td>{$row['st_height']}</td>";
    echo "<td>{$row['st_weight']}</td>";
    echo "<td>{$row['st_gender']}</td>";
    echo "<td><a href='deleteformwiththeme.php?deletedid={$row['st_id']}'>Delete</a></td>";
    echo "</tr>";
}
echo "</table>";
